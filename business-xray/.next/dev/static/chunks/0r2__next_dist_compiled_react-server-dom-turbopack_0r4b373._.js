...
"[project]/business-xray/node_modules/next/dist/compiled/react-server-dom-turbopack/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    function checkEvalAvailabilityOnceDev() {
        if (!hasConfirmedEval) {
            ...
            try {
                ...
                console.error("eval() is not supported in this environment. If this page was served with a `Content-Security-Policy` header, make sure that `unsafe-eval` is included. React requires eval() in development mode for various debugging features like reconstructing callstacks from a different environment.\nReact will never use eval() in production mode");
            }
        }
    }
    ...
    function createResponseFromOptions(options) {
        ...
        } : void 0, callServer = options && options.callServer ? options.callServer : void 0, temporaryReferences = options && options.temporaryReferences ? options.temporaryReferences : void 0, allowPartialStream = options && options.unstable_allowPartialStream ? options.unstable_allowPartialStream : !1, findSourceMapURL = options && options.findSourceMapURL ? options.findSourceMapURL : void 0, replayConsole = options ? !1 !== options.replayConsoleLogs : !0, environmentName = options && options.environmentName ? options.environmentName : void 0, debugStartTime = options && null != options.startTime ? options.startTime : void 0;
        options = options && null != options.endTime ? options.endTime : void 0;
        checkEvalAvailabilityOnceDev();
        return new ResponseInstance(null, null, null, callServer, void 0, void 0, temporaryReferences, allowPartialStream, findSourceMapURL, replayConsole, environmentName, debugStartTime, options, debugChannel)._weakResponse;
    }
...
"[project]/business-xray/node_modules/next/dist/compiled/react-server-dom-turbopack/client.browser.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
;
    ...
    module.exports = __turbopack_context__.r("[project]/business-xray/node_modules/next/dist/compiled/react-server-dom-turbopack/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)");
}
}),
"[project]/business-xray/node_modules/next/dist/compiled/react-server-dom-turbopack/client.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

module.exports = __turbopack_context__.r("[project]/business-xray/node_modules/next/dist/compiled/react-server-dom-turbopack/client.browser.js [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=0r2__next_dist_compiled_react-server-dom-turbopack_0r4b373._.js.map